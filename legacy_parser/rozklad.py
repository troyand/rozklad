...
def main():
    '''
    Main with some sanity testing
    '''
    from os import listdir
    import codecs
    import traceback, sys
    rozklad_dir = sys.argv[1]#'timetable_docs/fcss/'
    for rozklad_filename in listdir(rozklad_dir):
        rozklad_file = codecs.open(rozklad_dir + rozklad_filename, 'r', 'utf-8')
        text = rozklad_file.read()
        print rozklad_filename
        try:
        ...
        raw_input()
    #import docx
    #rozklad_filename = '/home/troyan/Downloads/4vesna2010-11.docx'
    #rozklad = docx.opendocx(rozklad_filename)
    #text_lines = docx.getdocumenttext(rozklad)
    #text = '\n'.join(text_lines)
    #rozklad = Rozklad(text)
